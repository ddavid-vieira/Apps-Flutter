...
class Unsuccessful extends StatefulWidget {
  @override
  _UnsuccessfulState createState() => _UnsuccessfulState();
}

class _UnsuccessfulState extends State<Unsuccessful> {
  Future<Map> _getUnsuccessful() async {
    http.Response response = await http.get(
        "https://damp-waters-69676.herokuapp.com/api/activities?invalids=true");
